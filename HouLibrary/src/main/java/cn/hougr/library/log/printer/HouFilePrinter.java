 ...
 */
public class HouFilePrinter implements IHouLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static HouFilePrinter instance;
     ...
     */
    public static synchronized HouFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new HouFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private HouFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull HouLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new HouLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(HouLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<HouLogMo> logs = new LinkedBlockingQueue<>();
