...
import cn.hougr.library.util.HouDisplayUtil;

public class HouViewPrinterProvider {
    ...
    public HouViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = HouDisplayUtil.dp2px(100);
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
            new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, HouDisplayUtil.dp2px(160));
